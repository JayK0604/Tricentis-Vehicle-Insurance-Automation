...
public class Motorcycle {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		modelDropDown.selectByVisibleText("Scooter");
		...
		//list price
		driver.findElement(By.id("listprice")).sendKeys("18000");
		
		// Annual Mileage
		driver.findElement(By.id("annualmileage")).sendKeys("9000");
		...
		// Expected Data
		String expPrice = "1,487.00";
		String expClaim = "Submit";
		String expDiscount = "10";
		String expCover = "Unlimited";
				
		// Actual Data
		String actPrice = driver.findElement(By.xpath("//table[@id='priceTable']/tbody/tr/td[5]/span")).getText();
		String actClaim = driver.findElement(By.xpath("//table[@id='priceTable']/tbody/tr[2]/td[5]")).getText();
		String actDiscount = driver.findElement(By.xpath("//table[@id='priceTable']/tbody/tr[3]/td[5]")).getText();
		String actCover = driver.findElement(By.xpath("//table[@id='priceTable']/tbody/tr[4]/td[5]")).getText();
		...
		try {
			FileUtils.copyFile(f1, new File("F:\\Seed\\Automation Testing\\AutomationProject\\Tricentis_Vehicle_Insurance_App\\ScreenShots\\Motorcycle.jpeg"));
		} catch(IOException e) {
			e.printStackTrace();
		}
